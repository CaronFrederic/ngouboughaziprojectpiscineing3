	...
	<body>
			...
			<div class="collapse navbar-collapse" id="main-navigation">
				...
				<ul class="navbar-nav">
					...
					if($userid=="" && $mail=="")
					{
					    ...
					    echo '<li class="nav-item"><a class="nav-link" href="connection.php?prev=bpmAi.php">Connectez Vous!</a></li>';
 
					    echo '<li class="nav-item"><a class="nav-link" href="connectionA.php?prev=bpmAi.php">Admin</a></li>';
					}else 
					{
						echo '<li id="inscrip" class="nav-item"><a class="nav-link" href="homepageac.php?userid='.$userid.'&mail='.$mail.'">Accueil</a></li>';
						
					    echo '<li id="inscrip" class="nav-item"><a class="nav-link" href="monEbay.php?prev=bpmAi.php&userid='.$userid.'&mail='.$mail.'">Mon EbayECE</a></li>';
 
					    echo '<li class="nav-item"><a class="nav-link" href="panier.php?prev=bpmAi.php&userid='.$userid.'&mail='.$mail.'">Panier</a></li>';
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-4">  <h1 class="titre">Bon pour Mus&eacute;e  Achat Im&eacute;diat</h1> </div>
		...
		<div class="row">
				...
				<div class="col-sm-2">  
					<button type="button" class="btn btn-light" <?php echo 'href="bpmEncher.php?userid='.$userid.'&mail='.$mail.'"'?>>
						<a class="btn btn-default" <?php echo 'href="bpmEncher.php?userid='.$userid.'&mail='.$mail.'"'?> role="button" style="color:black">Ench&egrave;re</a>
					</button> 
			    </div>
		...
		<div class="row">
			...
			<div class="col-sm-3" style="background-color:lightgreen;"><h3>Prix</h3></div>
			</div>
<?php
			try
			{
		...
		$reponse = $conn->query('SELECT * FROM Items WHERE Categorie=\'BPM\' AND AchatImediat=\'1\'');
...
?>
						<div class="row">
							...
							<div class="col-sm-3"><?php echo "<a href=\"items.php?id=".$donnees['ID']."&nom=".$donnees['Nom']."&prev=bpmAi.php&userid=".$userid."&mail=".$mail."\"><img src=\"image/".$donnees['Media']."\"width=\"300\" height=\"300\"></a>"; ?></div>
