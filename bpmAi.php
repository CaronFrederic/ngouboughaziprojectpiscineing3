...
<link rel="stylesheet" type="text/css" href="bpm.css">
	...
	<body>
		...
		<nav class="navbar navbar-expand-md">
			...
			<div class="collapse navbar-collapse" id="main-navigation">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="connection.php?prev=bpmAi.php">Connectez Vous!</a></li>
		...
		<div class="row">
				...
				<div class="col-sm-2">  
					<button type="button" class="btn btn-light" href="bpmEncher.php">
						<a class="btn btn-default" href="bpmEncher.php" role="button" style="color:black">Ench&egrave;re</a>
					</button> 
			    </div>
...
?>
						<div class="row">
							...
							<div class="col-sm-3"><?php echo "<a href=\"items.php?id=".$donnees['ID']."&nom=".$donnees['Nom']."&prev=bpmAi.php\"><img src=\"image/".$donnees['Media']."\"width=\"300\" height=\"300\"></a>"; ?></div>
