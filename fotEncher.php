	...
	<body>
			...
			<div class="collapse navbar-collapse" id="main-navigation">
				...
				<ul class="navbar-nav">
					...
					if($userid=="" && $mail=="")
					{
					    ...
					    echo '<li class="nav-item"><a class="nav-link" href="connection.php?prev=fotEncher.php">Connectez Vous!</a></li>';
 
					    echo '<li class="nav-item"><a class="nav-link" href="connectionA.php?prev=fotEncher.php">Admin</a></li>';
					}else 
					{
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-4">  <h1 class="titre">Ferraille/Tr&eacute;sors  Ench&egrave;re</h1> </div>
		...
		<div class="row">
			...
			<div class="col-sm-3" style="background-color:lightgreen;"><h3>Prix de d&eacute;part</h3></div>
			</div>
<?php
			try
			{
		...
		$reponse = $conn->query('SELECT * FROM Items WHERE Categorie=\'FOT\' AND Enchere=\'1\'');
...
?>
						<div class="row">
							...
							<div class="col-sm-3"><?php echo "<a href=\"items.php?id=".$donnees['ID']."&nom=".$donnees['Nom']."&prev=fotEncher.php&userid=".$userid."&mail=".$mail."\"><img src=\"image/".$donnees['Media']."\"width=\"300\" height=\"300\"></a>"; ?></div>
