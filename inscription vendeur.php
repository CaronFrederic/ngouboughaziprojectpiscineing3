...
<link rel="stylesheet" type="text/css" href="fot2.css">
	...
	<body>
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-4">  <h1 class="titre" >Cr&eacute;er un Compte !</h1> </div>
		...
		<div class="form-style">
			<form action="/my-handling-form-page" method="post"> 
				<div>
					...
					<input type="text" id="prenom" name="name">
				</div>
				<div>
				...
				<div>
					<label for="Pseudo">Pseudo (identifant) :</label>
					<input type="text" id="Pseudo" name="identifiant">
				</div>
				<div>
					<label for="mail">e-mail (mot de passe):</label>
                ...
                <div>
                    <label for="photo">Image de Fond </label>
                    <input type="file" name="photo" enctype= "multipart/form-data" />
                </div>
			</form>
			<div class="button">
