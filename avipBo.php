	...
	<body>
			...
			<div class="collapse navbar-collapse" id="main-navigation">
				...
				<ul class="navbar-nav">
					...
					if($userid=="" && $mail=="")
					{
					    ...
					    echo '<li class="nav-item"><a class="nav-link" href="connection.php?prev=avipBo.php">Connectez Vous!</a></li>';
 
					    echo '<li class="nav-item"><a class="nav-link" href="connectionA.php?prev=avipBo.php">Admin</a></li>';
					}else 
					{
					    ...
					    echo '<li id="inscrip" class="nav-item"><a class="nav-link" href="monEbay.php?prev=avipBo.php&userid='.$userid.'&mail='.$mail.'">Mon EbayECE</a></li>';
 
					    echo '<li class="nav-item"><a class="nav-link" href="panier.php?prev=avipBo.php&userid='.$userid.'&mail='.$mail.'">Panier</a></li>';
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-4">  <h1 class="titre">Acessoire VIP  Meilleure Offre</h1> </div>
...
<?php
		...
		$reponse = $conn->query('SELECT * FROM Items WHERE Categorie=\'AVIP\' AND BestOffre=\'1\'');
...
?>
						<div class="row">
							...
							<div class="col-sm-3"><?php echo "<a href=\"items.php?id=".$donnees['ID']."&nom=".$donnees['Nom']."&prev=avipBo.php&userid=".$userid."&mail=".$mail."\"><img src=\"image/".$donnees['Media']."\"width=\"300\" height=\"300\"></a>"; ?></div>
