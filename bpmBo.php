	...
	<body>
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-4">  <h1 class="titre">Bon pour Mus&eacute;e  Meilleure Offre</h1> </div>
...
<?php
		...
		$reponse = $conn->query('SELECT * FROM Items WHERE Categorie=\'BPM\' AND BestOffre=\'1\'');
...
?>
						<div class="row">
							...
							<div class="col-sm-3"><?php echo "<a href=\"items.php?id=".$donnees['ID']."&nom=".$donnees['Nom']."&prev=bpmBo.php&userid=".$userid."&mail=".$mail."\"><img src=\"image/".$donnees['Media']."\"width=\"300\" height=\"300\"></a>"; ?></div>
