		...
		<nav class="navbar navbar-expand-md">
			...
			<div class="collapse navbar-collapse" id="main-navigation">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="connection.php?prev=bpmBo.php">Connectez Vous!</a></li>
...
?>
						<div class="row">
							...
							<div class="col-sm-3"><?php echo "<a href=\"items.php?id=".$donnees['ID']."&nom=".$donnees['Nom']."&prev=bpmBo.php\"><img src=\"image/".$donnees['Media']."\"width=\"300\" height=\"300\"></a>"; ?></div>
