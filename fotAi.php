	...
	<body>
			...
			<div class="collapse navbar-collapse" id="main-navigation">
				...
				<ul class="navbar-nav">
					...
					if($userid=="" && $mail=="")
					{
					    ...
					    echo '<li class="nav-item"><a class="nav-link" href="connection.php?prev=fotAi.php">Connectez Vous!</a></li>';
 
					    echo '<li class="nav-item"><a class="nav-link" href="connectionA.php?prev=fotAi.php">Admin</a></li>';
					}else 
					{
						echo '<li id="inscrip" class="nav-item"><a class="nav-link" href="homepageac.php?userid='.$userid.'&mail='.$mail.'">Accueil</a></li>';
						
					    echo '<li id="inscrip" class="nav-item"><a class="nav-link" href="monEbay.php?prev=fotAi.php&userid='.$userid.'&mail='.$mail.'">Mon EbayECE</a></li>';
 
					    echo '<li class="nav-item"><a class="nav-link" href="panier.php?prev=fotAi.php&userid='.$userid.'&mail='.$mail.'">Panier</a></li>';
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-4">  <h1 class="titre">Ferraille/Tr&eacute;sors  Achat Im&eacute;diat</h1> </div>
		...
		<div class="row">
				...
				<div class="col-sm-2">  
					<button type="button" class="btn btn-light" <?php echo 'href="fot.php?userid='.$userid.'&mail='.$mail.'"'?>>
						<a class="btn btn-default" <?php echo 'href="fot.php?userid='.$userid.'&mail='.$mail.'"'?> role="button" style="color:black">Aucun</a>
					</button> 
			    </div>
				<div class="col-sm-2">  
...
<?php
		...
		$reponse = $conn->query('SELECT * FROM Items WHERE Categorie=\'FOT\' AND AchatImediat=\'1\'');
...
?>
						<div class="row">
							...
							<div class="col-sm-3"><?php echo "<a href=\"items.php?id=".$donnees['ID']."&nom=".$donnees['Nom']."&prev=fotAi.php&userid=".$userid."&mail=".$mail."\"><img src=\"image/".$donnees['Media']."\"width=\"300\" height=\"300\"></a>"; ?></div>
