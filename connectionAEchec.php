	...
	<body>
		...
		<div class="row">
			...
			<div class="col-sm-5"></div>
				...
				<br/><br/>	<center><h3 style="color:red;">username ou password incorrect </h3></center><br/><br/>
		<div class="row">
			
		<div class="col-sm-3"></div>
		<div class="col-sm-2"> <h2 style="background-color:#C0C0C0; text-align: center;">Username:</h2></div>
		<div class="col-sm-1"></div>
		<div class="col-sm-2" ><input type="text" name="mail" class="form-control" placeholder="Entrer un Username"></div>
		<div class="col-sm-3"></div>	
		...
		try
			...
			$reponse = $conn->query('SELECT * FROM Administrateur WHERE username=\''.$mail.'\' AND password=\''.$pass.'\'');
			$donnees=$reponse->fetch();
														 
			
			if($donnees['mail']==$mail && $donnees['pseudo']==$pass && $mail!="" && $pass!="" )
			{
				echo '<meta http-equiv="refresh" content="0;URL=admin.php?userid='.$donnees['ID'].'&mail='.$mail.'">';
				
			}else if( $mail!="" && $pass!="" ){
				echo '<meta http-equiv="refresh" content="0;URL=connectionAEchec.php?prev='.$prev.'">';
