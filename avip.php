			...
			<div class="collapse navbar-collapse" id="main-navigation">
				...
				<ul class="navbar-nav">
					...
					if($userid=="" && $mail=="")
					{
					    ...
					    echo '<li class="nav-item"><a class="nav-link" href="connection.php?prev=avip.php">Connectez Vous!</a></li>';
 
					    echo '<li class="nav-item"><a class="nav-link" href="connectionA.php?prev=avip.php">Admin</a></li>';
					}else 
					{
					    ...
					    echo '<li id="inscrip" class="nav-item"><a class="nav-link" href="monEbay.php?prev=avip.php&userid='.$userid.'&mail='.$mail.'">Mon EbayECE</a></li>';
 
					    echo '<li class="nav-item"><a class="nav-link" href="panier.php?prev=avip.php&userid='.$userid.'&mail='.$mail.'">Panier</a></li>';
		...
		<div class="row">
			...
			<div class="col-sm-1"></div>
				...
				<button type="button" class="btn btn-light" <?php echo 'href="avipBo.php?userid='.$userid.'&mail='.$mail.'"'?>>
						<a class="btn btn-default" <?php echo 'href="avip+Bo.php?userid='.$userid.'&mail='.$mail.'"'?> role="button" style="color:black">Meilleure Offre</a>
					</button> 
			    </div>
...
?>
						<div class="row">
							...
							<div class="col-sm-3"><?php echo "<a href=\"items.php?id=".$donnees['ID']."&nom=".$donnees['Nom']."&prev=avip.php&userid=".$userid."&mail=".$mail."\"><img src=\"image/".$donnees['Media']."\"width=\"300\" height=\"300\"></a>"; ?></div>
